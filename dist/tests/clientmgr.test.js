...
(0, globals_1.describe)('ClientManager Crud functions', () => {
    ...
    (0, globals_1.test)('bind', () => {
        ...
        (0, globals_1.expect)(mgr.bindedClientMap.size).toBe(1);
        (0, globals_1.expect)(mgr.hasClientFor('b')).toBeFalsy();
        (0, globals_1.expect)(mgr.getClientById(1)?.uid).toBe('');
        (0, globals_1.expect)(mgr.getClientById(0)?.uid).toBe('a');
        mgr.bind(0, 'b');
        (0, globals_1.expect)(mgr.bindedClientMap.size).toBe(1);
        (0, globals_1.expect)(mgr.hasClientFor('b')).toBeFalsy();
        (0, globals_1.expect)(mgr.getClientById(1)?.uid).toBe('');
    ...
    (0, globals_1.test)('fetch', () => {
        ...
        (0, globals_1.expect)(mgr.getClientById(1)).not.toBeUndefined();
    });
    (0, globals_1.test)('get session id', () => {
        (0, globals_1.expect)(mgr.getSessionId('a')).toBeGreaterThanOrEqual(0);
        (0, globals_1.expect)(mgr.getSessionId('wekrj')).toBe(-1);
    });
