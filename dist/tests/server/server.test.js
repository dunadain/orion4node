...
(0, globals_1.beforeEach)(async () => {
    server = new Server_1.Server('', 9008, 'connector', id1);
...
(0, globals_1.describe)('server shut down', () => {
    ...
    (0, globals_1.test)('shut down should reject', async () => {
        ...
        if (!natsComponent)
            return;
        globals_1.jest.spyOn(natsComponent, 'dispose').mockRejectedValue(new Error('nats error'));
    ...
    (0, globals_1.describe)('kill process', () => {
        (0, globals_1.it)('should call process.exit(0)', async () => {
            const mockExit = globals_1.jest.spyOn(process, 'exit').mockImplementation(() => undefined);
